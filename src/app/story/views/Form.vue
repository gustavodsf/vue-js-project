<template>
  <section class="section">
    <div class="container">
      <h1 class="title" v-if="currentRoute === 'storyCreate'">
        {{ $t("default.label.add", [$tc("default.label.story", 1)]) }}
      </h1>

      <h1 class="title" v-if="currentRoute === 'storyEdit'">
        ...
        >
          <b-step-item v-bind:label="$t('story.view.form.step.info')">
            <b-field
              ...
              v-bind:message="[
                !$v.story.title.required && $v.story.title.$error
          ...
          <b-step-item v-bind:label="$t('story.view.form.step.author')">
            <b-field v-bind:label="$t('story.view.form.label.leader')">
              <b-input v-bind:value="story.leader.name" disabled />
            </b-field>
              ...
              <template slot-scope="props">
                ...
                >
                  <b-field
                    v-bind:type="{
                      'is-danger':
                        story.archetypes.includes(props.row) &&
                        !props.row.character &&
                        !archetypesAreValid
                    }"
                    v-bind:message="[
        ...
        <div class="level m-t-3">
          <div class="level-left">
            <div class="level-item">
              <b-button v-if="activeStep > 0" v-on:click="previousStep" rounded>
  ...
  async beforeMount() {
    ...
    if (this.$route.params.id) {
      this.story.archetypes.forEach(storyArchetype => {
        this.archetypesTableData = this.archetypesTableData.filter(
          archetype => {

          ...
          <div class="columns mt-2">
            ...
            <div class="column">
              <div class="content">
                ...
                <ul>
                  <li
                    v-for="context in stage.contexts"
                    v-bind:key="context">
                    {{ context }}
                  </li>
                </ul>
  ...
  methods: {
    ...
    confirmDelete (stage) {
      ...
      this.$buefy.dialog.confirm({
        title: this.$t('default.confirm.delete.title', [this.$tc('default.label.stage', 1)]),
        message: this.$t('default.confirm.delete.message'),
        confirmText: this.$t('default.confirm.delete.confirmText', [this.$tc('default.label.stage', 1)]),
